...
struct db_command db_show_all_cmds[] = {
	/* temporary aliases for sanity preservation */
	{ "acts",	db_show_all_acts,	0,	0 },
	{ "threads",	db_show_all_acts,	0,	0 },
#if	NORMA_IPC
	{ "uids",	(db_func) db_show_all_uids,		0,	0 },
	{ "proxies",	(db_func) db_show_all_proxies,		0,	0 },
	{ "principals",	(db_func) db_show_all_principals,	0,	0 },
	{ "vuids",	(db_func) db_show_all_uids_verbose,	0,	0 },
	{ "deads",	(db_func) db_show_all_deads, 		0,	0 },
#endif	/* NORMA_IPC */
...
struct db_command db_show_cmds[] = {
...
#if	NORMA_IPC
	{ "packet",	(db_func) netipc_packet_print,	0,	0 },
	{ "pstate",	(db_func) netipc_pacstate_print,0,	0 },
	{ "pcs",	(db_func) netipc_pcs_print,	0,	0 },
#endif	/* NORMA_IPC */
#if	NORMA_VM
	...
	{ "zone",	db_show_one_zone,	0,	0 },
        { "spinlock",   db_show_one_spinlock,   0,      0 },
#if !NORMA_IPC
