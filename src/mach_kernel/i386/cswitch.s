...
Entry(Load_context)
	...
	movl	TH_TOP_ACT(%ecx),%ecx		/ get top activation
	movl	ACT_KERNEL_STACK(%ecx),%ecx	/ get kernel stack
...
Entry(Switch_context)
	...
	movl	TH_TOP_ACT(%eax),%ebx		/ get old_thread->top_act
	movl	%ecx,ACT_KERNEL_STACK(%ebx)	/ save old stack
	...
	movl	ACT_KERNEL_STACK(%esi),%ecx	/ get its kernel stack
...
Entry(switch_to_shutdown_context)
	...
	movl	TH_TOP_ACT(%eax),%eax		/ get old_thread->top_act
	movl	%ecx,ACT_KERNEL_STACK(%eax)	/ save old stack
