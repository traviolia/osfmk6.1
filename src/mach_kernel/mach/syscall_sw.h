...
kernel_trap(syscall_kernel_task_create,-85,4)

kernel_trap(syscall_vm_msync,-86,4)
kernel_trap(syscall_thread_set_exception_ports,-87,5)
kernel_trap(syscall_mach_port_destroy,-88,2)
...
kernel_trap(syscall_vm_region,-92,7)
...
kernel_trap(syscall_mach_port_move_member,-101,3)
kernel_trap(syscall_vm_remap,-102,11)
kernel_trap(syscall_mach_port_allocate_qos,-103,4)
kernel_trap(syscall_task_set_port_space,-104,2)
kernel_trap(syscall_mach_port_allocate_full,-105,5);
