...
/*
 * FAS Family Code and Revision Level: access macros
 *
...
#define	FAS_FAMILY_MASK		0xf8
#define FAS_REV_MASK		0x07

#define FAS_FAMILY_CODE		2

#define	FAS_FAMILY(code)				\
	(((code)&FAS_FAMILY_MASK)>>3)

#define FAS_REV(level)					\
	((level)&FAS_REV_MASK)
