...
#define IKOT_CLOCK		17
#define IKOT_CLOCK_CTRL		18
#define IKOT_PAGER_REP		19
#define IKOT_MASTER_DEVICE	20
#define IKOT_ACT		21
#define IKOT_SUBSYSTEM		22
#define IKOT_IO_DONE_QUEUE	23
#define IKOT_SEMAPHORE		24
#define IKOT_LOCK_SET		25
					/* << new entries here	*/
#define	IKOT_UNKNOWN		26	/* magic catchall	*/
#define	IKOT_MAX_TYPE		27	/* # of IKOT_ types	*/
