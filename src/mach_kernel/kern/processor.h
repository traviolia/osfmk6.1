...
struct processor_set {
	...
	spinlock_t		idle_lock;	/* lock for above */
	...
	mutex_t			lock;		/* lock for everything else */
	...
	spinlock_t		quantum_adj_lock;  /* lock for above */
...
#define processor_lock(pr)	spinlock_lock(&(pr)->lock)
#define processor_unlock(pr)	spinlock_unlock(&(pr)->lock)
